...
public class LlamaContext {
  ...
  public LlamaContext(int id, Bundle params) {
    ...
    this.context = initContext(
      ...
      // int n_ctx,
      params.containsKey("n_ctx") ? params.getInt("n_ctx") : 4096,
      // int n_batch,
...
//    }
    ...
    return doCompletion(
      ...
      params.containsKey("penalty_repeat") ? params.getFloat("penalty_repeat") : 1.00f,
      // float penalty_freq,
      ...
      // boolean penalize_nl,
      params.containsKey("penalize_nl") ? params.getBoolean("penalize_nl") : false,
      // int top_k,
